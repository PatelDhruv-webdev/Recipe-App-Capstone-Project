...
//    @IBOutlet weak var sortButton: UIBarButtonItem! // Assuming you have a sort button
//
//    var recipes = [Recipe]()
...
//    var isSortingAscending: Bool = true // Default sorting order
//
...
//    }
//
//    private func sortRecipesByPreparationTime() {
//        filteredRecipes.sort { (recipe1, recipe2) -> Bool in
//            let time1 = getPreparationTime(for: recipe1)
//            let time2 = getPreparationTime(for: recipe2)
//            return isSortingAscending ? time1 < time2 : time1 > time2
//        }
//    }
//
//    private func getPreparationTime(for recipe: Recipe) -> Int {
